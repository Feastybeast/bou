...
from bou.backing.helpers import Location
from bou.constants import DOT_PY, UNDERSCORE

# Either a python module.location or FS path
SourceSpec = typing.Union[Location.output, pathlib.Path]


def list(spec: SourceSpec, starting: int = 0, stopping: int = sys.maxsize):
